...
@tool
async def strategy_performance_expert_stream(query: str) -> AsyncGenerator[Dict[str, Any], None]:
    """
    流式版本的基金策略与业绩专家，负责分析基金的投资策略、风格以及历史业绩、波动性和风险调整收益。
    ...
    """
    logger.info(f"调用流式基金策略与业绩专家: {query}")
