"""
This module provides a manager class for MCP servers that can be used with Strands agents in Lambda environment.
"""
...
class MCPServerManager:
    """
    Manages MCP server connections and tools for Lambda environment.
    ...
    Lambda版本的MCP服务器管理器，针对Lambda环境进行了优化：
    - 减少了连接和断开连接的开销
    - 简化了服务器状态管理
    - 优化了日志记录
    """
